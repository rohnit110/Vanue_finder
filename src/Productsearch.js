...
class Productsearch extends React.Component{
    ...
    componentDidMount()
    {
        var aid = parseInt(this.props.match.params.id)
        var tid1 = parseInt(this.props.match.params.id1)
        console.log("ID is " + aid);
        console.log("ID is " + tid1);
        var vid = parseInt(this.props.match.params.id)
        console.log("ID is "  + vid);
        axios.get(`https://akashsir.in/myapi/venue_finder/api/api-list-venue-filter.php?area_id=${aid}&type_id=${tid1}`)
        .then(res => {
